...
all four connections pass the shared behavior cases, every field and event in profile v1 and all five pinned real packages pass
component and workflow smoke cases, failure/recovery cases
